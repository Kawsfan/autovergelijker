...
.cat-badge{display:inline-block;background:#eff6ff;color:#1a56db;font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.04em;padding:.3rem .7rem;border-radius:20px;margin-bottom:.9rem}
h1{font-size:1.9rem;font-weight:800;line-height:1.25;margin-bottom:.9rem;color:#111}
.byline{display:flex;flex-wrap:wrap;gap:.4rem 1rem;font-size:.82rem;color:#777;margin-bottom:1.75rem;padding-bottom:1.5rem;border-bottom:1px solid #e5e5ea}
.byline b{color:#444}
.intro{font-size:1.08rem;color:#333;background:#fff;border-left:4px solid #1a56db;border-radius:0 10px 10px 0;padding:1.1rem 1.3rem;margin-bottom:2rem}
.toc{background:#fff;border:1px solid #e5e5ea;border-radius:10px;padding:1.1rem 1.4rem;margin-bottom:2rem}
...
article h2{font-size:1.25rem;font-weight:700;margin-bottom:.6rem;color:#111;scroll-margin-top:1rem}
article p{font-size:.98rem;color:#333;margin-bottom:.8rem}
article a{color:#1a56db}
.faq-sectie{margin-top:2.5rem;background:#fff;border:1px solid #e5e5ea;border-radius:10px;padding:1.4rem 1.6rem}
.faq-sectie h2{font-size:1.1rem;font-weight:700;margin-bottom:1rem}
details{border-top:1px solid #eee;padding:.85rem 0}
details:first-of-type{border-top:none}
summary{font-weight:600;cursor:pointer;font-size:.92rem;color:#222}
summary::marker{color:#1a56db}
details p{margin-top:.5rem;font-size:.88rem;color:#444}
.gerelateerd-cta{margin-top:2rem;text-align:center;background:#1a56db;border-radius:12px;padding:1.6rem}
.gerelateerd-cta p{color:#fff;font-size:.95rem;margin-bottom:.8rem;font-weight:600}
.gerelateerd-cta a{display:inline-block;background:#fff;color:#1a56db;font-weight:700;font-size:.9rem;padding:.6rem 1.4rem;border-radius:8px;text-decoration:none}
.back-link{display:inline-block;margin-top:2.5rem;color:#1a56db;font-size:.875rem;text-decoration:none}`;
...
function buildArtikelPage(art) {
  ...
  return '<!DOCTYPE html>\n<html lang="nl">\n<head>\n' +
    ...
    '  <style>' + STYLE + '<\/style>\n' +
    '</head>\n<body>\n' +
    '  <nav><a href="/">Carkijker</a><a href="/artikelen/">Artikelen</a><a href="' + canonicalPath + '">' + art.titel + '</a></nav>\n' +
    '  <div class="container">\n' +
...
.art-card{display:block;background:#fff;border:1px solid #e5e5ea;border-radius:12px;padding:1.3rem 1.5rem;text-decoration:none;color:inherit;transition:box-shadow .15s}
.art-card:hover{box-shadow:0 4px 16px rgba(0,0,0,.06)}
.art-card h2{font-size:1.15rem;font-weight:700;margin:.5rem 0 .4rem;color:#111}
...
.art-meta{font-size:.78rem;color:#999}`;
  ...
  return '<!DOCTYPE html>\n<html lang="nl">\n<head>\n' +
    ...
    '</head>\n<body>\n' +
    '  <nav><a href="/">Carkijker</a><a href="/artikelen/">Artikelen</a></nav>\n' +
    '  <div class="container">\n' +
    '    <h1>Artikelen</h1>\n' +
